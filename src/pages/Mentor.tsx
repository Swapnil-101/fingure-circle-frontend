                                                ...
                                                <div className="mb-6">
                                                    <div className="flex items-center justify-between pb-6 mb-6 border-b">
                                                        <div>
                                                            ...
                                                            <p className="text-5xl font-extrabold">₹{selectedMentor?.fees}</p>
                                                    ...
                                                    <div>
                                                        <p className="mb-2 font-bold tracking-wide">About</p>
                                                        <ul className="space-y-2">
                                                            <li className="flex items-center space-x-2">
                                                                ...
                                                                <p className="text-gray-800">{selectedMentor?.verified ? "Verified" : "UnVerified"}</p>
                                                            </li>
                                                            <li className="flex items-center space-x-2">
                                                                <span className="text-blue-gray-400">
                                                                    <svg
                                                                ...
                                                                {/* <p className="text-gray-800">10GB Storage</p> */}
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>

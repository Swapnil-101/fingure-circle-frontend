...
const Note: React.FC = () => {
    return (
        <div className="w-full max-w-sm px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800 mt-[2rem]">
            <div className="flex items-center justify-between">
                <span className="text-sm font-light text-gray-800 dark:text-gray-400">Notes</span>
                <span className="px-3 py-1 text-xs text-blue-800 uppercase bg-blue-200 rounded-full dark:bg-blue-300 dark:text-blue-900">Notes From Mentor</span>
            </div>

            <div>
                <div className='flex items-center gap-2'>
                    <h1 className="mt-2 text-lg font-semibold text-gray-800 dark:text-white">1.</h1>
                    <h1 className="mt-2 text-lg font-semibold text-gray-800 dark:text-white">Time</h1>
                </div>
